...
/**
 *
 * Contains the InvalidBaseCurrencyException class
 *
 ...
 *
 */
class InvalidBaseCurrencyException extends \Exception
{
	/**
	 * Create a new InvalidBaseCurrencyException with $message.
